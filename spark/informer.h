...
typedef struct {
    ...
    InformerPupUI               setup_ui_quality;       /* upload quality */
...
int InformerGetQuality(void);
double InformerGetFrameRate(void);
unsigned long *InformerQualityChanged(int CallbackArg, SparkInfoStruct SparkInfo);
